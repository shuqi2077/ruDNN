...
macro_rules! interpolate_typed {
    ($fn_name:ident, $impl_fn:ident, $T:ty) => {
        pub fn $fn_name(x: HostTensor, output_size: [usize; 2], align_corners: bool) -> HostTensor {
...
macro_rules! interpolate_bf16 {
    ($bf16_fn:ident, $f32_fn:ident) => {
        pub fn $bf16_fn(x: HostTensor, output_size: [usize; 2], align_corners: bool) -> HostTensor {
...
interpolate_backward_typed!(
    interpolate_lanczos3_backward_f32,
    interpolate_lanczos3_backward_impl,
    f32
);
interpolate_backward_typed!(
    interpolate_lanczos3_backward_f64,
    interpolate_lanczos3_backward_impl,
    f64
);
interpolate_backward_typed!(
    interpolate_lanczos3_backward_f16,
    interpolate_lanczos3_backward_impl,
    f16
);
interpolate_backward_bf16!(
    interpolate_lanczos3_backward_bf16,
    interpolate_lanczos3_backward_f32
);
    ...
    T: Float + ruda_core::tensor::element::Element + bytemuck::Pod + Send + Sync,
{
    ...
    let output = {
        ...
        #[cfg(feature = "rayon")]
        if out_numel >= ruda_core::tensor::host::parallel::PARALLEL_THRESHOLD {
            use rayon::prelude::*;
    ...
    T: Float + ruda_core::tensor::element::Element + bytemuck::Pod + Send + Sync,
{
    ...
    fn lanczos3_sample<T: Float + ruda_core::tensor::element::Element + bytemuck::Pod>(
        input: &[T],
        in_base: usize,
        in_width: usize,
        y_in: f64,
...
use lanczos3_backward::interpolate_lanczos3_backward_impl;

// ============================================================================
// Dtype conversion helpers
// ============================================================================

fn convert_bf16_to_f32(x: &HostTensor) -> HostTensor {
...
fn convert_f32_to_bf16(x: &HostTensor) -> HostTensor {
    let x = x.clone().to_contiguous();
