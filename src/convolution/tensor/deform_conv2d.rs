...
pub(crate) fn deform_im2col<R: Runtime>(
    input: RudaTensor<R>,
    offset: RudaTensor<R>,
...
pub fn deform_conv2d<R: Runtime>(
    input: RudaTensor<R>,
    offset: RudaTensor<R>,
    weight: RudaTensor<R>,
    mask: Option<RudaTensor<R>>,
    ...
    let [out_h, out_w] = options.output_size([in_height, in_width], [kernel_h, kernel_w]);
    assert_eq!(
        [offset.meta.shape()[2], offset.meta.shape()[3]], [out_h, out_w],
