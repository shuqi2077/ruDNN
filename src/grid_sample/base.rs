...
use ruda_core::tensor::spatial::GridSampleOptions;
use ruda_core::tensor::spatial::GridSamplePaddingMode;
...
pub fn grid_sample<R: Runtime>(
    ...
    match options.mode {
        ...
        InterpolateMode::Nearest => super::nearest::launch(input, grid, options),
        InterpolateMode::Bicubic => super::bicubic::launch(input, grid, options),
        _ => panic!(
