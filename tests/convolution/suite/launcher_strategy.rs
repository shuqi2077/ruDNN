...
use ruda_kernel::tiling::{InputBinding, MatrixLayout, SwizzleModes};
use ruda_test_utils::{ExecutionOutcome, TestInput, TestOutcome, launch_and_capture_outcome};

use rudnn::convolution::cpu_reference::assert_result;
...
pub fn test_algo(
    ...
    let outcome = launch_and_capture_outcome(&client, |c| {
        match rudnn::convolution::launch_ref(&strategy, c, inputs, args, dtypes_for_launch) {
